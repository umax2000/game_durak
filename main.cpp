...
int main()
{
    ...
    {
        bool vpl_take = false;
        //ќпредел€ютс€ apl и vpl.
        vector<Pair> heap;

        //        APL LOOP
        //            apl кладет карту(ы),
        //  провер€€ есть-ли она в pair_collection (если он не пустой),
        //  формируетс€ pair
        //            vpl дополн€ет pair, либо берет все карты из нее.
        //        APL LOOP END
        ...
        //        ALL LOOP
        //            ¬се игроки открывают pair (если карты этого достоинства есть в pair_collection).
        //            vpl отбиваетс€, либо забирает все pair со стола.
        //            ≈сли отбиваетс€ - все pair уход€т в биту.
        //        ALL LOOP END
        ...
        //»дет добор карт до 6-ти (если это возможно).
        //≈сли у игрока нет карт - он выходит из игры.
